<template>
    <div class="banner_container">
            ...
            <div class="wrap_img">
                <svg width="96" height="96" fill="none">
                    ...
                    <path opacity="0.4" d="M82.23 85.77a1.967 1.967 0 1 0 0-3.934 1.967 1.967 0 0 0 0 3.934Z"
                        fill="url(#A)"></path>
                    <path opacity="0.4" d="M81.836 82.623a2.36 2.36 0 1 0 0-4.721 2.36 2.36 0 0 0 0 4.721Z" fill="url(#B)">
                    </path>
                    <path opacity="0.4" d="M77.902 82.623a2.36 2.36 0 1 0 0-4.721 2.36 2.36 0 0 0 0 4.721Z" fill="url(#C)">
                    </path>
        ...
        <div class="wrap_text">
            <p class="heading">Tutto ciò che ami di Netflix a soli 5,49 €.</p>
            <p class="subHeading">Scegli il piano Standard con pubblicità.</p>
            <button role="link" class="link_banner">Scopri di più
